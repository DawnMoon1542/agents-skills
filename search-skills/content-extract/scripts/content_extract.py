#!/usr/bin/env python3
"""content-extract: deterministic MinerU-only extractor.

Why this exists:
- The agent's `web_fetch` is a tool, not available inside scripts.
...
Usage:
  uv run python scripts/content_extract.py --url <URL> [--model MinerU-HTML]
...
def _find_mineru_wrapper() -> str:
    ...
    # 3. Search skills workspace default
